...
IOP_VERSION:=$(CONFIG_TARGET_MODEL_NAME)_$(CONFIG_TARGET_CUSTOMER)$(CONFIG_TARGET_VERSION)-$(shell date '+%y%m%d_%H%M')
IOP_BUILD_VERSION:=$(shell echo $(IOP_VERSION) | sed s/\"//g)
